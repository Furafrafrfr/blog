...
type FileFieldsEnum =
  ...
  | 'childMarkdownRemark.frontmatter.development'
  ...
  | 'childrenMarkdownRemark.frontmatter.development'
...
type MarkdownRemarkFrontmatter = {
  ...
  readonly development: Maybe<Scalars['Boolean']>;
...
type MarkdownRemarkFrontmatterFilterInput = {
  ...
  readonly development: InputMaybe<BooleanQueryOperatorInput>;
...
type AppQuery = { readonly file: { readonly childImageSharp: { readonly gatsbyImageData: Record<string, unknown> } | null } | null };
...
type BlogPageQuery = { readonly site: { readonly siteMetadata: { readonly description: string | null, readonly lang: string | null, readonly siteUrl: string | null, readonly title: string | null } | null } | null, readonly file: { readonly childImageSharp: { readonly gatsbyImageData: Record<string, unknown> } | null } | null, readonly markdownRemark: { readonly html: string | null, readonly frontmatter: { readonly category: ReadonlyArray<string | null> | null, readonly title: string | null, readonly slug: string | null, readonly date: string | null } | null } | null };
...
type CategoryQuery = { readonly site: { readonly siteMetadata: { readonly siteUrl: string | null, readonly description: string | null, readonly lang: string | null, readonly title: string | null } | null } | null, readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: { readonly category: ReadonlyArray<string | null> | null, readonly date: string | null, readonly slug: string | null, readonly title: string | null } | null } }> }, readonly file: { readonly childImageSharp: { readonly gatsbyImageData: Record<string, unknown> } | null } | null };
...
type HeaderQuery = { readonly file: { readonly name: string, readonly childImageSharp: { readonly gatsbyImageData: Record<string, unknown> } | null } | null };

type HomeQueryVariables = Exact<{ [key: string]: never; }>;


type HomeQuery = { readonly site: { readonly siteMetadata: { readonly siteUrl: string | null, readonly description: string | null, readonly lang: string | null, readonly title: string | null } | null } | null, readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: { readonly category: ReadonlyArray<string | null> | null, readonly date: string | null, readonly slug: string | null, readonly title: string | null } | null } }> }, readonly file: { readonly childImageSharp: { readonly gatsbyImageData: Record<string, unknown> } | null } | null };

type GatsbyNodeQueryVariables = Exact<{ [key: string]: never; }>;


type GatsbyNodeQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: { readonly category: ReadonlyArray<string | null> | null, readonly slug: string | null, readonly date: string | null, readonly title: string | null } | null } }> } };
